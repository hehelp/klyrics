...
foobar2000 视觉歌词组件：内嵌面板、透明桌面歌词、Windows 任务栏歌词。歌词来自本地 `.lrc` 和首选项「使用中」的源（[LRCLIB](https://lrclib.net)、酷狗、QQ 音乐、网易云、内嵌歌词），按该列表顺序查找，未加入的源不会搜。支持行级卡拉 OK 和打轴编辑。英文显示名 **Klyrics**。
